    ...
    */
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      */
      ...
      key: 'getHighlightRectangle',
      value: function getHighlightRectangle(index) {
        var layout = this.props.layout;
        ...
        var tooltipTicks = this.state.tooltipTicks;
      ...
      value: function updateStateOfAxisMapsOffsetAndStackGroups(_ref5) {
        ...
        var stackGroups = (0, _ChartUtils.getStackGroupsByAxisId)(data, graphicalItems, numericAxisName + 'Id', cateAxisName + 'Id', stackOffset);
        var axisObj = axisComponents.reduce(function (result, entry) {
    ...
    this.renderHighlight = function (element) {
      if (!element || !element.props.index) {
        return null;
      }

      var offset = _this7.state.offset;


      var restProps = _this7.getHighlightRectangle(element.props.index);
      var highlightComp = _Rectangle2.default;

      var key = element.key || '_recharts-highlight';

      var highlightProps = _extends({
        stroke: '#ccc'
      }, offset, restProps, element.props.fill ? { fill: element.props.fill } : {}, element.props.stroke ? { stroke: element.props.stroke } : {}, {
        key: key,
        className: 'recharts-highlight'
      });

      return (0, _react.createElement)(highlightComp, highlightProps);
    };
